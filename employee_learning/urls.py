...
from .views import CourseList, CourseDetail, CourseCreate, CourseUpdate, CourseDelete, EmployeeDetail, Index
...
urlpatterns = [
    ...
    path('employee-detail/<int:pk>/', EmployeeDetail.as_view(), name='employee_detail'),
]
